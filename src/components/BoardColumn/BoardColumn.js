...
import { onInputPressEnter, selectAllInlineText } from 'utilities/contentEditable'
      ...
      <header className='column-drag-handle'>
        ...
        <span className='column-dropdown-actions'>
          <Dropdown>
            ...
            <Dropdown.Menu>
              <Dropdown.Item onClick={toggleNewCardArea}>Add card...</Dropdown.Item>
      ...
      <footer>
        {openNewCard && (
          <div className='add-new-card-area-actions'>
            <Button className='add-new-col success' variant='success' size='sm' onClick={addNewCard}>
              Add list
            </Button>
